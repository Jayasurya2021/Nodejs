...
import { Box, Upload, ArrowLeft, Save, Plus, X, Palette } from 'lucide-react';
...
const CreateProduct = () => {
  ...
  const handleImageClick = (e, preview) => {
    ...
    // Using natural width and height mapped to client bounds for accurate pixel extraction
    ...
    try {
      ...
      toast.error("Could not read pixel data. Try another image.");
    }
  };

  // Variant & Fabric & Size management
  const addVariant = () => {
    const newVariant = { 
      color: '', 
    ...
    // If they picked a color from an image, automatically assign that image to the variant
  ...
  // Size array management within variant
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      // 2. Upload variant images sequentially & clean payload
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 min-h-screen">
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-2">Add a new product to your store. Provide deep manual customizations.</p>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <p className="text-sm font-bold text-gray-600">Click to upload main images</p>
              </div>
              <input 
                type="file" 
                multiple 
