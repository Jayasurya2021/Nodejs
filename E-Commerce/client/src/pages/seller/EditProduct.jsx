                      ...
                      <div className="lg:col-span-4 border-r border-gray-100 pr-0 lg:pr-8">
                        ...
                        <div className="bg-gray-50 rounded-2xl p-5 border border-gray-100">
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div className="relative w-16 h-16 rounded-full border border-gray-200 overflow-hidden flex-shrink-0">
                              <div className="w-full h-full" style={{ backgroundColor: variant.colorHex }}></div>
                              <input
                                type="color"
