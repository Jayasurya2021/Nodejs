    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-12 lg:gap-20">
        ...
        <div className="w-full md:w-1/2 flex flex-col">
          ...
          <h1 className="text-3xl lg:text-4xl font-black tracking-tight mb-3">{product.title}</h1>
          ...
          <div className="border-t border-gray-100 pt-6">
            ...
            <p className="text-gray-500 text-sm leading-relaxed mb-6 whitespace-pre-line">{product.description}</p>
                      ...
                      {review.images?.length > 0 && (
                        <div className="flex gap-2 mb-4">
                          {review.images.map((img, idx) => (
                            <img key={idx} src={img} alt="Review" className="w-16 h-16 object-cover border border-gray-200" />
                          ))}
                        </div>
                      )}
