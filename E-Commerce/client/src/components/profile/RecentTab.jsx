...
const RecentTab = () => {
  ...
  const recentProducts = [
    { id: '1', name: 'Silk Blend Midi Dress', brand: 'LookFashion', price: 120, oldPrice: 150, image: 'https://placehold.co/300x300', inStock: true },
    { id: '2', name: 'Cashmere V-Neck Sweater', brand: 'LookFashion', price: 85, image: 'https://placehold.co/300x300', inStock: true },
    { id: '3', name: 'Leather Chelsea Boots', brand: 'LookFashion', price: 195, oldPrice: 220, image: 'https://placehold.co/300x300', inStock: false },
    { id: '4', name: 'Tailored Wool Trousers', brand: 'LookFashion', price: 110, image: 'https://placehold.co/300x300', inStock: true },
  ];
