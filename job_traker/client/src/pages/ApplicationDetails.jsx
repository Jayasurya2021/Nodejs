...
const ApplicationDetails = () => {
  ...
  if (!application) {
    return (
      <div className="p-8 text-center bg-white border border-slate-200 rounded-3xl my-12 shadow-xs">
        <h3 className="text-xl font-extrabold text-slate-800">
          Application Not Found
        </h3>
        <button
          onClick={() => navigate('/applications')}
          className="mt-4 px-5 py-2.5 rounded-xl bg-indigo-600 text-white font-bold text-xs shadow-md shadow-indigo-600/20 cursor-pointer"
        >
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="px-4 py-2 rounded-xl bg-amber-500 hover:bg-amber-600 text-white font-bold text-xs shadow-sm flex items-center gap-1.5 transition-all"
          >
      ...
      <div className="bg-white border border-slate-200/80 rounded-3xl p-6 sm:p-8 shadow-xs">
          ...
          <div className="flex items-center gap-5">
            {companyLogo && !imgError ? (
              <img
                ...
                className="w-16 h-16 rounded-2xl object-contain bg-slate-50 p-2 border border-slate-200 shadow-2xs"
              />
            ) : (
        ...
        <div className="my-6">
          <p className="text-xs uppercase font-extrabold text-slate-400 tracking-wider mb-2">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4.5 rounded-2xl bg-slate-50 border border-slate-200/80 my-6">
        ...
        <div className="flex flex-wrap items-center gap-4 py-3">
          {jobUrl && (
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-indigo-50 text-indigo-700 font-bold text-xs border border-indigo-200 hover:bg-indigo-100 transition-colors shadow-2xs"
            >
          ...
          {companyWebsite && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-100 text-slate-700 font-bold text-xs border border-slate-200 hover:bg-slate-200 transition-colors shadow-2xs"
            >
          ...
          {interviewDate && (
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-purple-50 text-purple-700 font-bold text-xs border border-purple-200 shadow-2xs">
        ...
        {jobDescription && (
          <div className="mt-8 space-y-2">
            ...
            <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200/80 text-sm text-slate-800 leading-relaxed whitespace-pre-line font-medium">
              {jobDescription}
            </div>
          </div>
        )}
        ...
        {notes && (
          <div className="mt-6 space-y-2">
            ...
            <div className="p-5 rounded-2xl bg-amber-50/60 border border-amber-200 text-sm text-slate-800 leading-relaxed whitespace-pre-line italic font-serif">
              {notes}
            </div>
          </div>
        )}
